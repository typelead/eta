...
INTEGRAL_TYPE(CInt,Int32)
-- | Haskell type representing the C @unsigned int@ type.
INTEGRAL_TYPE(CUInt,Word32)

-- | Haskell type representing the C @long@ type.
INTEGRAL_TYPE(CLong,Int64)
-- | Haskell type representing the C @unsigned long@ type.
INTEGRAL_TYPE(CULong,Word64)
...
INTEGRAL_TYPE(CSigAtomic,Int32)
...
ARITHMETIC_TYPE(CClock,Word64)
-- | Haskell type representing the C @time_t@ type.
ARITHMETIC_TYPE(CTime,Int64)
-- | Haskell type representing the C @useconds_t@ type.
--
-- @since 4.4.0.0
ARITHMETIC_TYPE(CUSeconds,Word32)
-- | Haskell type representing the C @suseconds_t@ type.
--
-- @since 4.4.0.0
ARITHMETIC_TYPE(CSUSeconds,Int32)
...
INTEGRAL_TYPE(CIntPtr,Int64)
INTEGRAL_TYPE(CUIntPtr,Word64)
INTEGRAL_TYPE(CIntMax,Int64)
INTEGRAL_TYPE(CUIntMax,Word64)
