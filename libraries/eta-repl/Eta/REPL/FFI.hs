...
prepForeignCall cconv arg_types result_type = do
  ...
  cif <- mallocBytes undefined -- (#const sizeof(ffi_cif))
...
ffi_type_void    :: Ptr C_ffi_type
ffi_type_void    = undefined
ffi_type_uint8   :: Ptr C_ffi_type
ffi_type_uint8   = undefined
ffi_type_sint8   :: Ptr C_ffi_type
ffi_type_sint8   = undefined
ffi_type_uint16  :: Ptr C_ffi_type
ffi_type_uint16  = undefined
ffi_type_sint16  :: Ptr C_ffi_type
ffi_type_sint16  = undefined
ffi_type_uint32  :: Ptr C_ffi_type
ffi_type_uint32  = undefined
ffi_type_sint32  :: Ptr C_ffi_type
ffi_type_sint32  = undefined
ffi_type_uint64  :: Ptr C_ffi_type
ffi_type_uint64  = undefined
ffi_type_sint64  :: Ptr C_ffi_type
ffi_type_sint64  = undefined
ffi_type_float   :: Ptr C_ffi_type
ffi_type_float   = undefined
ffi_type_double  :: Ptr C_ffi_type
ffi_type_double  = undefined
ffi_type_pointer :: Ptr C_ffi_type
ffi_type_pointer = undefined

fFI_OK            :: C_ffi_status
fFI_OK            = undefined -- (#const FFI_OK)
...
fFI_DEFAULT_ABI = undefined -- (#const FFI_DEFAULT_ABI)
#if defined(mingw32_HOST_OS) && defined(i386_HOST_ARCH)
fFI_STDCALL     :: C_ffi_abi
fFI_STDCALL     = undefined -- (#const FFI_STDCALL)
#endif
