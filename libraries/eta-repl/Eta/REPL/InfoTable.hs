...
conInfoPtr :: Ptr () -> Ptr ()
conInfoPtr ptr
 | ghciTablesNextToCode = undefined -- ptr `plusPtr` (#size StgConInfoTable)
 | otherwise            = ptr
...
stg_interp_constr1_entry :: EntryFunPtr
stg_interp_constr1_entry = undefined
stg_interp_constr2_entry :: EntryFunPtr
stg_interp_constr2_entry = undefined
stg_interp_constr3_entry :: EntryFunPtr
stg_interp_constr3_entry = undefined
stg_interp_constr4_entry :: EntryFunPtr
stg_interp_constr4_entry = undefined
stg_interp_constr5_entry :: EntryFunPtr
stg_interp_constr5_entry = undefined
stg_interp_constr6_entry :: EntryFunPtr
stg_interp_constr6_entry = undefined
stg_interp_constr7_entry :: EntryFunPtr
stg_interp_constr7_entry = undefined
...
pokeConItbl
  ...
  -> IO ()
pokeConItbl wr_ptr ex_ptr itbl = undefined
...
newExecConItbl obj con_desc
   = alloca $ \pcode -> do
        let lcon_desc = length con_desc + 1{- null terminator -}
            sz = undefined-- fromIntegral ((#size StgConInfoTable) + sizeOfEntryCode)
...
_allocateExec = undefined

_flushExec :: CUInt -> Ptr a -> IO ()
_flushExec = undefined

-- -----------------------------------------------------------------------------
-- Constants and config

wORD_SIZE :: Int
wORD_SIZE = undefined -- (#const SIZEOF_HSINT)
...
rtsIsProfiledIO :: IO CInt
rtsIsProfiledIO = undefined

rtsIsProfiled :: Bool
rtsIsProfiled = unsafeDupablePerformIO rtsIsProfiledIO /= 0

cONSTR :: Int   -- Defined in ClosureTypes.h
cONSTR = undefined -- (#const CONSTR)
#endif /* ETA_REPL */
