...
import ETA.HsSyn.HsSyn            hiding (flattenHsForAllTyKeepAnns)
...
import ETA.Utils.OrdList          ( OrdList, fromOL )
import ETA.Utils.Bag              ( emptyBag, consBag )
