...
-- @
module Eta.Parser.Parser (parseModule, parseSignature, parseImport,
               parseStatement, parseBackpack,
...
-- compiler/main
import Eta.Main.HscTypes         ( IsBootInterface, WarningTxt(..) )
import Eta.Main.DynFlags
import Eta.Main.PackageConfig

-- compiler/backpack
import Eta.Backpack.BkpSyn

-- compiler/utils
import Eta.Utils.OrdList
import Eta.Utils.BooleanFormula   ( BooleanFormula(..), mkTrue )
...
import Eta.Types.Kind             ( Kind, liftedTypeKind, unliftedTypeKind, mkArrowKind )
import Eta.Types.Class            ( FunDep )

-- compiler/parser
import Eta.Parser.RdrHsSyn
import Eta.Parser.Lexer
import Eta.Parser.HaddockUtils
...
import Eta.Prelude.TysPrim          ( liftedTypeKindTyConName, eqPrimTyCon )
...
capi_ctype : '{-# CLASS' STRING STRING '#-}'
