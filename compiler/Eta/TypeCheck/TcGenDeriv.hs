...
import Eta.Core.MkCore ( eRROR_ID )
import Eta.Prelude.PrelNames hiding (error_RDR)
import Eta.BasicTypes.MkId ( coerceId )
...
import Eta.Utils.Encoding ( toBase62, toBase62Padded )
...
import Eta.TypeCheck.TcEnv (InstInfo)
...
eq_Expr tycon ty a b
    ...
    | isObjectType ty         = genOpApp a eqObject_RDR b
