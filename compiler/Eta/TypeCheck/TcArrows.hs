...
module Eta.TypeCheck.TcArrows ( tcProc ) where

import {-# SOURCE #-}  Eta.TypeCheck.TcExpr( tcMonoExpr, tcInferRho, tcSyntaxOp, tcCheckId, tcPolyExpr )

import Eta.HsSyn.HsSyn
import Eta.TypeCheck.TcMatches
import Eta.TypeCheck.TcHsSyn( hsLPatType )
...
import Eta.BasicTypes.Id( mkLocalId )
