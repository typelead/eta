{-# OPTIONS_GHC -fno-warn-orphans #-} -- We don't want to spread the HasOccName
                                      -- instance for Either
module Eta.TypeCheck.TcHoleErrors ( findValidHoleFits ) where
...
import Eta.BasicTypes.RdrName ( pprNameProvenance , GlobalRdrElt (..), globalRdrEnvElts )
import Eta.Prelude.PrelNames ( gHC_ERR )
...
import Eta.TypeCheck.TcEnv (tcLookup)
import Eta.Utils.Outputable
import Eta.Main.DynFlags
import Eta.Utils.Maybes
import Eta.Utils.FV ( fvVarList, fvVarSet, unionFV, mkFVs, FV )
...
import Eta.TypeCheck.TcSimplify    ( simpl_top, runTcSDeriveds )
