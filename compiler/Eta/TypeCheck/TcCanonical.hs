{-# LANGUAGE CPP #-}
module Eta.TypeCheck.TcCanonical(
     canonicalize,
     unifyDerived,
...
import Eta.TypeCheck.FamInst ( tcTopNormaliseNewTypeTF_maybe )
import Eta.BasicTypes.Var
import qualified Eta.BasicTypes.Var as Var
import Eta.BasicTypes.DataCon ( dataConName )
import Eta.BasicTypes.Name( isSystemName, nameOccName )
import Eta.BasicTypes.OccName( OccName )
...
import Eta.Utils.MonadUtils ( zipWith3M, zipWith3M_ )
