...
import {-# SOURCE #-}   Eta.TypeCheck.TcExpr( tcPolyExpr, tcSyntaxOp )
import {-# SOURCE #-}   Eta.TypeCheck.TcUnify( unifyType )
...
tyVarsOfCt (CIrredCan { cc_ev = ev })                    = tyVarsOfType (ctEvPred ev)
