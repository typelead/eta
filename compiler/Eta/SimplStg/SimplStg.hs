...
module Eta.SimplStg.SimplStg ( stg2stg ) where
...
import Eta.Profiling.SCCfinal         ( stgMassageForProfiling )
import Eta.StgSyn.StgLint          ( lintStgBindings )
import Eta.SimplStg.StgStats         ( showStgStats )
import Eta.SimplStg.UnariseStg       ( unarise )

import Eta.Main.DynFlags
import Eta.BasicTypes.Module           ( Module )
import Eta.Main.ErrUtils
import Eta.BasicTypes.SrcLoc
import Eta.BasicTypes.UniqSupply       ( mkSplitUniqSupply, splitUniqSupply )
