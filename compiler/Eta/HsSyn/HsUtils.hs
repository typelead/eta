...
mkHsSpliceTy hasParen e = HsSpliceTy (HsUntypedSplice hasParen unqualSplice e) placeHolderType
...
hsLTyClDeclBinders (L loc (ClassDecl   { tcdLName = L _ cls_name
  ...
  = L loc cls_name :
    ...
    [ L mem_loc mem_name | L mem_loc (TypeSig ns _ _ _) <- sigs, L _ mem_name <- ns ]
