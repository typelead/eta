...
module Eta.DeSugar.DsArrows ( dsProcExpr ) where

import Eta.DeSugar.Match
import Eta.DeSugar.DsUtils
import Eta.DeSugar.DsMonad

import Eta.HsSyn.HsSyn    hiding (collectPatBinders, collectPatsBinders, collectLStmtsBinders, collectLStmtBinders, collectStmtBinders )
import Eta.TypeCheck.TcHsSyn
import qualified Eta.HsSyn.HsUtils as HsUtils
...
import Eta.DeSugar.DsBinds (dsHsWrapper)
...
import Eta.Utils.ListSetOps( assocDefault )
