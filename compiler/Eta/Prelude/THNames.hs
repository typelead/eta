...
qTyConName, nameTyConName, fieldExpTyConName, patTyConName,
    ...
    tExpTyConName, injAnnTyConName, kindTyConName, overlapTyConName,
...
funDName, valDName, dataDName, newtypeDName, tySynDName, classDName,
    ...
    pragAnnDName, standaloneDerivDName, defaultSigDName,
...
javaCallName       = libFun (fsLit "java") javaCallIdKey
...
matchQTyConName, clauseQTyConName, expQTyConName, stmtQTyConName,
  ...
  -- , kindQTyConName, tyVarBndrQTyConName :: Name
...
expTyConKey, matchTyConKey, clauseTyConKey, qTyConKey, expQTyConKey,
    ...
    tyVarBndrTyConKey, decTyConKey, bangTypeQTyConKey, varBangTypeQTyConKey,
...
funDIdKey, valDIdKey, dataDIdKey, newtypeDIdKey, tySynDIdKey, classDIdKey,
    ...
    newtypeInstDIdKey, tySynInstDIdKey, standaloneDerivDIdKey,
...
cCallIdKey, stdCallIdKey, cApiCallIdKey, primCallIdKey,
  javaScriptCallIdKey, javaCallIdKey :: Unique
...
javaCallIdKey       = mkPreludeMiscIdUnique 425
