...
import Eta.Core.CoreSyn     ( AltCon, Tickish )
import Eta.Profiling.CostCentre  ( CostCentreStack )
import Eta.BasicTypes.DataCon
import Eta.Main.DynFlags
import Eta.Utils.FastString
import Eta.Prelude.ForeignCall ( ForeignCall )
import Eta.BasicTypes.Id
import Eta.BasicTypes.IdInfo      ( mayHaveCafRefs )
...
import Eta.BasicTypes.VarSet      ( IdSet, isEmptyVarSet )
