...
import {-# SOURCE #-}   Eta.Types.TypeRep( Type, Kind, SuperKind )
import {-# SOURCE #-}   Eta.TypeCheck.TcType( TcTyVarDetails, pprTcTyVarDetails )
import {-# SOURCE #-}   Eta.BasicTypes.IdInfo( IdDetails, IdInfo, coVarDetails, vanillaIdInfo, pprIdDetails )
