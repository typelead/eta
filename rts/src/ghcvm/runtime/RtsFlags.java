...
import static ghcvm.runtime.Rts.ExitCode.EXIT_SUCCESS;
...
public class RtsFlags {
    ...
    public static void setup(String[] args,
        ...
        String env = System.getenv("GHCVM_RTS");
        if (env != null) {
            if (rtsOptsEnabled == RtsOptsNone) {
                errorRtsOptsDisabled(isHsMain, "Warning: Ignoring GHCVM_RTS variable as RTS options are disabled.\n         %s");
            } else {
                splitRtsFlags(env);
