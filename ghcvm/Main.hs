...
main' postLoadMode dflags0 args flagWarnings = do
  ...
  handleSourceError (\e -> do
    ...
    case postLoadMode of
       ...
       DoInteractive          -> liftIO $ putStrLn "GHCVMi not implemented yet" -- ghciUI srcs Nothing
       DoEval exprs           -> liftIO $ putStrLn "GHCVMi not implemented yet" -- ghciUI srcs $ Just $ reverse exprs
